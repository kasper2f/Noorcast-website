...
export default function WhyUs() {
  const features = [
    {
      title: 'جودة إنتاج بمعايير احترافية',
      desc: 'نستخدم معدات احترافية وسير عمل مدروس لضمان نتائج متسقة تناسب الحملات التسويقية والعلامات التجارية.',
      icon: <Film className="text-amber-500" size={28} />
    },
    {
      title: 'إدارة متكاملة وليست مجرد نشر',
      desc: 'نبني خطة محتوى، ننتج المواد الإبداعية، وندير النشر والمتابعة من مكان واحد.',
      icon: <LayoutGrid className="text-amber-500" size={28} />
    },
    {
      title: 'خدمات تناسب احتياجات مشروعك',
      desc: 'اختر باقة جاهزة أو صمم خدمتك بنفسك مع إمكانية إضافة الخدمات التي تحتاجها فقط.',
      icon: <Megaphone className="text-amber-500" size={28} />
    },
    {
      title: 'شفافية في الأسعار',
      desc: 'نعرض أسعار خدماتنا بوضوح مع خيارات تخصيص مرنة، لتتمكن من اختيار ما يناسب مشروعك ومعرفة التكلفة قبل بدء التنفيذ.',
